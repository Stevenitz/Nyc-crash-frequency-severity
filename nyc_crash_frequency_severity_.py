...
print(model3.summary())   # winner has double the explaining power



# Residuals vs Fitted

# Residual diagnostics- funnel shape is expected on log scale for count data
